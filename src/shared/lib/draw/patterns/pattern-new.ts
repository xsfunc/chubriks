...
export const newPattern: PatternProcessor<NewPatternOptions, NewPatternSerialized> = {
  ...
  svg: (options, fillingFactory) => {
    ...
    const figureColor = fillingFactory.fillingByOptions(options.color2)
    const pattern = SVG()
      .pattern(...size)
